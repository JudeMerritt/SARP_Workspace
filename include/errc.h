...
typedef enum {
  ...
  TI_ERRC_BUSY,          /** @brief The peripheral/resource is currently in use. */
  ...
  TI_ERRC_COUNT,         /** @brief Total number of error codes */
}ti_errc_t;
 ...
 */
const char* ti_get_errc_name(ti_errc_t errc_in, ti_errc_t* errc_out);
 ...
 * @warning - TI_ERRC_INVALID_ARG is raised if @p [errc_in] is not a valid enumeration value.
 */
const char* ti_get_errc_desc(ti_errc_t errc_in, ti_errc_t* errc_out);