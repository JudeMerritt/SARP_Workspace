...
const char* ti_get_errc_name(const ti_errc_t errc_in, ti_errc_t* const errc_out) {
  switch (errc_in) {
...
const char* ti_get_errc_desc(const ti_errc_t errc_in, ti_errc_t* const errc_out) {
  switch (errc_in) {
